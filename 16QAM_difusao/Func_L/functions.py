"""
Funções de apoio para o experimento de difusão com 16-QAM, SPE e
...
# =============================================================================
# Modulação 16-QAM e filtro RCF
# =============================================================================


def rcf_filter(beta: float, sps: int, span: int) -> np.ndarray:
    """
    Cria o filtro Raised Cosine Filter usado para limitar a banda do sinal.
...
def gerar_16qam(
    ...
    h_rcf = rcf_filter(rolloff, sps, span)
    sinal_filtrado = np.convolve(sinal_16qam, h_rcf, mode="same")
    ...
    return t, sinal_16qam, sinal_filtrado, simbolos_array, h_rcf
...
def unshuffle_amplitude_on_indices(
    ...
    Esta função não é usada no experimento de difusão, mas fica pronta para
