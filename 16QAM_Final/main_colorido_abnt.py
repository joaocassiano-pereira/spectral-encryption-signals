...
#   - constelação em mapa de densidade à direita
...
CONSTELLATION_SCATTER_ROUNDS = 20 # quantas rodadas coloridas sobrepor na constelação
...
def plot_article_style_figure(results):
    ...
    for i, ((letter, stage_title, _, _), mean_mag, individual_curves, constellation_rounds) in enumerate(
        ...
        # a redistribuição das amplitudes depois do embaralhamento espectral.
    ...
    if SAVE_FIGURE:
        ...
        print(
            ...
            "(c) após o embaralhamento espectral; (d) após o desembaralhamento "
